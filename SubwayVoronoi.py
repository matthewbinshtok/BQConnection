...
"""
Matthew Binshtok
Subway Voronoi Generator
"""
import pandas as pd
from scipy.spatial import Voronoi, voronoi_plot_2d
import folium

#File with subway locations in NYC:
trains = pd.read_csv('Subways.csv')
...
#For each row in the CSV, pull out the latitude, longitude, and name of the station:
...
mapVor.geo_json(geo_path= 'trainVor.json', fill_color = "BuPu", 
                fill_opacity=0.01, line_opacity=0.25)
mapVor.save(outfile='hw9-3.html')
